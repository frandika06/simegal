            ...
            if ($i > 0) {
                if ($item[1] !== null) {
                    ...
                    $value_1 = [
                        ...
                        "no_urut" => (int) $no_urut,
                        "group_instrumen" => $item[4],
                        "nama_instrumen" => $item[5],
                        "volume_from" => (int) $item[6],
                        "volume_to" => (int) $item[7],
                        "volume_per" => (int) $item[8],
                        "satuan" => $item[9],
                        "tera_baru_pengujian" => (int) $item[10],
                        "tera_baru_pejustiran" => (int) $item[11],
                        "tera_ulang_pengujian" => (int) $item[12],
                        "tera_ulang_pejustiran" => (int) $item[13],
                        "tarif_per_jam" => (int) $item[14],
