...
class SetAppsInsUttpJenisController extends Controller
{
    /**
    ...
    {
        return view('pages.admin.settings_apps.master.uttp.instrumen.jenis_uttp.index');
    }
    ...
    public function show($enc_uuid)
    {
        ...
        return view('pages.admin.settings_apps.master.uttp.instrumen.jenis_uttp.view', compact(
            'enc_uuid',
            'title',
            'data',
        ));
    ...
    public function edit($enc_uuid)
    {
        ...
        $submit = "Simpan";
        return view('pages.admin.settings_apps.master.uttp.instrumen.jenis_uttp.create_edit', compact(
            'enc_uuid',
            'title',
            'submit',
            'data',
