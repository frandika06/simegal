    ...
    <div class="aside-menu flex-column-fluid ps-5 pe-3 mb-7" id="kt_aside_menu">
        ...
        <div class="w-100 hover-scroll-y d-flex pe-2" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_footer, #kt_header"
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention menu-active-bg fw-semibold my-auto" id="#kt_aside_menu" data-kt-menu="true">
                ...
                <div class="menu-item">
                    {{-- begin:Menu link --}}
                    <a class="menu-link" href="{{ route('spv.apps.home.index') }}">
                        <span class="menu-icon">
                ...
                <div class="menu-item">
                    {{-- begin:Menu link --}}
                    <a class="menu-link" href="{{ route('spv.apps.input.pdp.index') }}">
                        <span class="menu-icon">
                ...
                {{-- begin:Menu item --}}
                {{-- <div class="menu-item">
                    <a class="menu-link" href="{{ route('spv.apps.mnj.penera.index') }}">
                        <span class="menu-icon">
                ...
                {{-- begin:Menu item --}}
                <div class="menu-item">
                    <a class="menu-link" href="{{ route('spv.apps.data.pdp.index') }}">
                        <span class="menu-icon">
                ...
                {{-- begin:Menu item --}}
                <div class="menu-item">
                    <a class="menu-link" href="{{ route('spv.apps.insalat.index') }}">
                        <span class="menu-icon">
                            <i class="fa-solid fa-scale-balanced fs-2"></i>
                        </span>
                ...
                <div class="menu-item">
                    {{-- begin:Menu link --}}
                    <a class="menu-link" href="{{ route('spv.apps.tinjut.mt.index') }}">
                        <span class="menu-icon">
                ...
                <div class="menu-item">
                    {{-- begin:Menu link --}}
                    <a class="menu-link" href="{{ route('spv.apps.tinjut.uapv.index') }}">
                        <span class="menu-icon">
                            <i class="fa-solid fa-chalkboard-user fs-2"></i></i>
                        </span>
                ...
                <div class="menu-item">
                    {{-- begin:Menu link --}}
                    <a class="menu-link" href="{{ route('spv.apps.tinjut.bdkt.index') }}">
                        <span class="menu-icon">
                            <i class="fa-solid fa-chalkboard-user fs-2"></i></i>
                        </span>
