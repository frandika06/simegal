                                        ...
                                        @foreach ($alertTera as $item)
                                            ...
                                            <div class="d-flex flex-stack py-4">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    {{-- begin::Title --}}
                                                    <div class="mb-0 me-2">
                                                        <a href="{{ route('scd.apps.data.pdp.show', [\CID::encode($item->uuid)]) }}" class="fs-6 text-gray-800 text-hover-primary fw-bold">{{ $item->RelPermohonanPeneraan->RelPerusahaan->nama_perusahaan }}</a>
