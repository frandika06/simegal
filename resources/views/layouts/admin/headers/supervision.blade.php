            ...
            @elseif($subRoleOnlyPetugas == true)
                ...
                <div class="d-flex align-items-center me-2 me-lg-4">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true" id="kt_menu_notifications">
                        ...
                        <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url({!! asset('assets-apps/media/misc/menu-header-bg.jpg') !!})">
                            {{-- begin::Title --}}
                            <h3 class="text-white fw-semibold px-9 mt-10 mb-6">Nofifikasi</h3>
                            {{-- end::Title --}}
                            {{-- begin::Tabs --}}
                            <ul class="nav nav-line-tabs nav-line-tabs-2x nav-stretch fw-semibold px-9">
                                <li class="nav-item">
                        ...
                        <div class="tab-content">
                            {{-- begin::Tab panel --}}
                            <div class="tab-pane fade show active" id="kt_topbar_alert_tera" role="tabpanel">
                                {{-- begin::Items --}}
                                <div class="scroll-y mh-325px my-5 px-8">
                                    @if (count($alertTera) > 0)
                                        @foreach ($alertTera as $item)
                                            {{-- begin::Item --}}
                                            <div class="d-flex flex-stack py-4">
                                                {{-- begin::Section --}}
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    {{-- begin::Title --}}
                                                    <div class="mb-0 me-2">
                                                        <a href="{{ route('spv.apps.data.pdp.show', [\CID::encode($item->uuid)]) }}" class="fs-6 text-gray-800 text-hover-primary fw-bold">{{ $item->RelPermohonanPeneraan->RelPerusahaan->nama_perusahaan }}</a>
                                                        <div class="text-gray-400 fs-7">Order: {{ $item->nomor_order }}</div>
                                                    </div>
                                                    {{-- end::Title --}}
                                                </div>
                                                {{-- end::Section --}}
                                                {{-- begin::Label --}}
                                                <span class="badge badge-light fs-8">{{ \CID::tglSimple($item->tanggal_peneraan) }}</span>
                                                {{-- end::Label --}}
                                            </div>
                                            {{-- end::Item --}}
                                        @endforeach
                            ...
                            {{-- end::Tab panel --}}
                            {{-- begin::Tab panel --}}
                            <div class="tab-pane fade" id="kt_topbar_alert_tulang" role="tabpanel">
                                {{-- begin::Items --}}
                                <div class="scroll-y mh-325px my-5 px-8">
                                    @if (count($alertTulang) > 0)
                                        @foreach ($alertTulang as $item)
                                            {{-- begin::Item --}}
                                            <div class="d-flex flex-stack py-4">
                                                {{-- begin::Section --}}
                                                <div class="d-flex align-items-center">
                            ...
                            {{-- end::Tab panel --}}
                            {{-- begin::Tab panel --}}
                            <div class="tab-pane fade" id="kt_topbar_alert_bdkt" role="tabpanel">
                                {{-- begin::Items --}}
                                <div class="scroll-y mh-325px my-5 px-8">
                                    @if (count($alertBdkt) > 0)
                                        @foreach ($alertBdkt as $item)
                                            {{-- begin::Item --}}
                                            <div class="d-flex flex-stack py-4">
                                                {{-- begin::Section --}}
                                                <div class="d-flex align-items-center">
                            ...
                            @if ($cPdpPetugas > 0)
                                <div class="py-3 text-center border-top">
                                    <a href="{{ route('spv.apps.data.pdp.index') }}" class="btn btn-color-gray-600 btn-active-color-primary">Lihat Semua
                                        <i class="ki-duotone ki-arrow-right fs-5">
                                            <span class="path1"></span>
                                            <span class="path2"></span>
                                        </i></a>
