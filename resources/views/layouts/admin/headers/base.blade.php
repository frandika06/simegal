                                ...
                                <div class="card-body px-0">
                                    ...
                                    <div class="dlab-scroll px-3 mt-3 height300">
                                        <ul class="d-flex align-items-center mb-3">
                                            <li>
                                                <img src="{{ asset('assets-admin/dist/images/avatar/1.jpg') }}" class="avatar avatar-sm" alt="">
                                        ...
                                        <ul class="d-flex align-items-center mb-3">
                                            <li>
                                                <img src="{{ asset('assets-admin/dist/images/avatar/2.jpg') }}" class="avatar avatar-sm" alt="">
                                        ...
                                        <ul class="d-flex align-items-center mb-3">
                                            <li>
                                                <img src="{{ asset('assets-admin/dist/images/avatar/4.jpg') }}" class="avatar avatar-sm" alt="">
                                                <a href="javascript:void(0);" class="ms-2">Benjamin</a>
                                        ...
                                        <ul class="d-flex align-items-center mb-3">
                                            <li>
                                                <img src="{{ asset('assets-admin/dist/images/avatar/3.jpg') }}" class="avatar avatar-sm" alt="">
                                                <a href="javascript:void(0);" class="ms-2">Benjamin</a>
                                    ...
                                    <li>
                                        <div class="timeline-panel">
                                            <div class="media me-2">
                                                <img alt="image" width="50" src="{{ asset('assets-admin/dist/images/avatar/1.jpg') }}">
                                            </div>
                        ...
                        <div class="dropdown header-profile2">
                            <a class="nav-link ms-0" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <div class="header-info2 d-flex align-items-center">
                                    ...
                                    <img src="{{ asset('assets-admin/dist/images/user.jpg') }}" alt="">
                                </div>
                            </a>
