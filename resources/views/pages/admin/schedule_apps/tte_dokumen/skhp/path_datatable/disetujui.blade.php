{{-- begin:::Tab pane --}}
<div class="tab-pane fade" id="tab_tte_disetujui" role="tabpanel">
    {{-- begin::Card --}}
    <div class="card pt-4 mb-6 mb-xl-9">
        ...
        <div class="card-body pt-0 pb-5">
            ...
            <div class="table-responsive">
                {{-- begin::Table --}}
                <table id="datatableDisetujui" class="table table-striped table-hover table-row-bordered gy-5 gs-7 border rounded">
...
@push('scripts')
    ...
    <script>
        ...
        $('[name="q_tahun"]').change(function() {
            ...
            $('#datatableDisetujui tbody').empty();
            tableDisetujui.ajax.reload(null, true);
            getStatistikTteSkhp();
        });
        ...
        var tableDisetujui = $('#datatableDisetujui').DataTable({
            "select": false,
            "paging": true,
            "searching": true,
            "ordering": true,
