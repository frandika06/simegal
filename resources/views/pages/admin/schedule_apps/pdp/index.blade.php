        ...
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
            ...
            <div class="page-title d-flex flex-column me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
                    ...
                    {{-- end::Item --}}
                    {{-- begin::Item --}}
                    <li class="breadcrumb-item text-dark">Penjadwalan & Penugasan</li>
                    {{-- end::Item --}}
                </ul>
                {{-- end::Breadcrumb --}}
            </div>
            ...
            <div class="d-flex flex-column flex-lg-row">
                ...
                <div class="flex-lg-row-fluid">
                    ...
                    <div class="tab-content" id="myTabContent">
                        {{-- path-baru::begin --}}
                        @include('pages.admin.schedule_apps.pdp.path_datatable.tera')
                        {{-- path-baru::end --}}
                        {{-- path-diproses::begin --}}
                        @include('pages.admin.schedule_apps.pdp.path_datatable.tera_ulang')
                        {{-- path-diproses::end --}}
                        {{-- path-selesai::begin --}}
                        @include('pages.admin.schedule_apps.pdp.path_datatable.bdkt')
                        {{-- path-selesai::end --}}
                    </div>
                    {{-- end:::Tab content --}}
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(".path-tab").click(function() {
                ...
                localStorage.setItem('tabsPenjadwalanPenugasan', href);
            })
        });

        function getTabsProfil() {
            var tabsPenjadwalanPenugasan = localStorage.getItem('tabsPenjadwalanPenugasan');
            if (tabsPenjadwalanPenugasan === null) {
                localStorage.setItem('tabsPenjadwalanPenugasan', '#profile_tab_tera');
                ...
                $(".tabs-profile>li").each(function(index) {
                    if ($(this).find('a[href^="' + tabsPenjadwalanPenugasan + '"]')) {
                        $('a[href^="' + tabsPenjadwalanPenugasan + '"]').addClass(" active");
                        $(tabsPenjadwalanPenugasan).addClass(" show active");
                    }
                });
            }
        }
