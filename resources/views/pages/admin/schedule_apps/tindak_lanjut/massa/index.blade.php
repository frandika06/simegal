...
@endpush
@push('title')
    Massa/Timbangan (MT) | Tindak Lanjut | SIMEGAL
@endpush
@push('description')
    Massa/Timbangan (MT) | Tindak Lanjut | Sistem Informasi Metrologi Legal Pemerintah Kabupaten Tangerang
@endpush
@push('header-title')
    Massa/Timbangan (MT) | Tindak Lanjut
@endpush
        ...
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
            ...
            <div class="page-title d-flex flex-column me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
                    ...
                    {{-- end::Item --}}
                    {{-- begin::Item --}}
                    <li class="breadcrumb-item text-dark">Massa/Timbangan (MT)</li>
                    {{-- end::Item --}}
                </ul>
                {{-- end::Breadcrumb --}}
            </div>
            ...
            <div class="d-flex flex-column flex-lg-row">
                ...
                <div class="flex-lg-row-fluid">
                    ...
                    <div class="tab-content" id="myTabContent">
                        {{-- path-baru::begin --}}
                        @include('pages.admin.schedule_apps.tindak_lanjut.massa.path_datatable.tera')
                        {{-- path-baru::end --}}
                        {{-- path-diproses::begin --}}
                        @include('pages.admin.schedule_apps.tindak_lanjut.massa.path_datatable.tera_ulang')
                        {{-- path-diproses::end --}}
                    </div>
                    {{-- end:::Tab content --}}
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(".path-tab").click(function() {
                ...
                localStorage.setItem('tabsTinjutMassa', href);
            })
        });

        function getTabsProfil() {
            var tabsTinjutMassa = localStorage.getItem('tabsTinjutMassa');
            if (tabsTinjutMassa === null) {
                localStorage.setItem('tabsTinjutMassa', '#profile_tab_tera');
                ...
                $(".tabs-profile>li").each(function(index) {
                    if ($(this).find('a[href^="' + tabsTinjutMassa + '"]')) {
                        $('a[href^="' + tabsTinjutMassa + '"]').addClass(" active");
                        $(tabsTinjutMassa).addClass(" show active");
                    }
                });
            }
        }
