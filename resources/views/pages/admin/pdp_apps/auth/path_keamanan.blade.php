    ...
    <div class="card pt-4 mb-6 mb-xl-9">
        ...
        <div class="card-header border-0">
            ...
            <div class="card-title flex-column">
                <h2>Keamanan Akun</h2>
                <div class="fs-6 fw-semibold text-muted">Halaman untuk mengubah data username dan password anda.</div>
            </div>
            {{-- end::Card title --}}
        </div>
        {{-- end::Card header --}}
        ...
        <div class="card-body">
            ...
            <form action="{{ route('pdp.apps.auth.profile.update') }}" class="form" enctype="multipart/form-data" method="POST">
                ...
                <div class="form-floating mb-5">
                    <input type="text" class="form-control @error('username') is-invalid @enderror" name="username" id="username2" placeholder="Username" autocomplete="off" maxlength="100" value="{{ $auth->username }}" required />
