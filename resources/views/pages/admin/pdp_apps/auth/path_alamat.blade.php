                ...
                <form action="{{ route('pdp.apps.auth.profile.update') }}" method="POST" id="formAlamat">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-5">
                            ...
                            <select class="form-select" name="district_id" id="district_id" data-control="select2" data-dropdown-parent="#add_alamat_perusahaan" data-placeholder="Pilih Kecamatan" data-allow-clear="true" required>
                                <option></option>
                        ...
                        <div class="mb-5">
                            ...
                            <select class="form-select" name="village_id" id="village_id" data-control="select2" data-dropdown-parent="#add_alamat_perusahaan" data-placeholder="Pilih Kelurahan/Desa" data-allow-clear="true" required>
                                <option></option>
                            </select>
                        </div>
                        {{-- end::village_id --}}
