    ...
    <div class="card pt-4 mb-6 mb-xl-9">
        ...
        <div class="card-header border-0">
            ...
            <div class="card-title flex-column">
                <h2>Data Permohonan Status <strong>Ditolak</strong></h2>
            </div>
            {{-- end::Card title --}}
        </div>
        {{-- end::Card header --}}
        ...
        <div class="card-body pt-0 pb-5">
            ...
            <div class="table-responsive">
                {{-- begin::Table --}}
                <table id="datatable4" class="table table-striped table-hover table-row-bordered gy-5 gs-7 border rounded">
