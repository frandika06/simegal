...
@endpush
@push('description')
    FAQ | Sistem Informasi Metrologi Legal Pemerintah Kabupaten Tangerang
@endpush
@push('header-title')
    FAQ
@endpush
...
@section('content')
    <div class="content-body">
        <div class="container-fluid">
            <form action="{{ isset($data) ? route('prt.apps.faq.update', [$uuid_enc]) : route('prt.apps.faq.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @isset($data)
                    @method('put')
                @endisset
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    ...
                                    <div class="mb-3 row">
                                        <label class="col-sm-3 col-form-label">Post <span class="wajib">*</span></label>
                                        <div class="col-sm-9">
                                            <textarea class="form-control @error('post') is-invalid @enderror" name="post" id="post" cols="5" rows="15" placeholder="Masukkan Post." maxlength="10000" autocomplete="off" required>{{ old('post', isset($data) ? str_replace('<br />', '', $data->post) : '') }}</textarea>
                                            @error('post')
                                                <div id="postFeedback" class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                ...
                <div class="mb-5 row">
                    <div class="col-sm-12 text-end">
                        <a href="{{ route('prt.apps.faq.index') }}" class="btn btn-light btn-rounded me-2"><i class="fa fa-times"></i> Batal</a>
