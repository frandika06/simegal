...
@section('content')
    <div class="content-body">
        <div class="container-fluid">
            <form action="{{ isset($data) ? route('prt.apps.gallery.update', [$uuid_enc]) : route('prt.apps.gallery.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @isset($data)
                    @method('put')
                @endisset
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control @error('deskripsi') is-invalid @enderror" name="deskripsi" id="deskripsi" cols="5" rows="5" placeholder="Masukkan Deskripsi." maxlength="1000" autocomplete="off" required>{{ old('deskripsi', isset($data) ? str_replace('<br />', '', $data->deskripsi) : '') }}</textarea>
                                            @error('deskripsi')
                ...
                <div class="mb-5 row">
                    <div class="col-sm-12 text-end">
                        <a href="{{ route('prt.apps.gallery.index') }}" class="btn btn-light btn-rounded me-2"><i class="fa fa-times"></i> Batal</a>
