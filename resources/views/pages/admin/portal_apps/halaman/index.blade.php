                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header border-0 p-3">
                            <h4 class="heading mb-0">Data Halaman</h4>
                        </div>
                        <div class="card-header flex-wrap border-0">
                            <div>
                                <a href="{{ route('prt.apps.page.create') }}" class="btn btn-primary btn-sm"><i class="fa-solid fa-plus me-2"></i>Tambah Data</a>
                            </div>
                            <div>
    ...
    <script>
        ...
        $(document).on('click', "[data-delete]", function() {
            ...
            swal({
                ...
                function() {
                    $.ajax({
                        url: "{!! route('prt.apps.page.destroy') !!}",
                        type: 'POST',
                        data: {
                            uuid: uuid,
                            _token: "{{ csrf_token() }}"
