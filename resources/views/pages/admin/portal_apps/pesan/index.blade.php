...
@endpush
@push('description')
    Pesan | Sistem Informasi Metrologi Legal Pemerintah Kabupaten Tangerang
@endpush
@push('header-title')
    Pesan
@endpush
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header border-0 p-3">
                            <h4 class="heading mb-0">Data Pesan</h4>
                        </div>
                        <div class="card-header flex-wrap border-0">
                            ...
                            <div>
                                <select class="form-control" name="q_status_post" id="q_status_post">
                                    ...
                                    <option value="Readed" @if ($status == 'Readed') selected @endif>Readed</option>
                                </select>
                            </div>
                        </div>
...
@push('scripts')
    ...
    <script>
        ...
        var table = $('#datatable').DataTable({
            ...
            "ajax": {
                url: "{!! route('prt.apps.pesan.index') !!}",
                type: 'GET',
                data: function(data) {
                    data.filter = {
        ...
        $(document).on('click', "[data-delete]", function() {
            ...
            swal({
                ...
                function() {
                    $.ajax({
                        url: "{!! route('prt.apps.pesan.destroy') !!}",
                        type: 'POST',
                        data: {
                            uuid: uuid,
                            _token: "{{ csrf_token() }}"
