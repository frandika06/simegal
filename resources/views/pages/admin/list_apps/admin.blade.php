...
@section('content')
                ...
                <div class="row g-7 w-xxl-850px">
                            ...
                            <div class="card-body d-flex flex-column flex-center pb-0 pt-15">
                                ...
                                <div class="px-10 mb-5">
                                    ...
                                    <div class="mb-7">
                                        ...
                                        <div class="d-flex align-items-center mb-2">
                                            <i class="ki-duotone ki-black-right fs-4 text-white opacity-75 me-3"></i>
                                            <span class="text-white opacity-75">Postingan</span>
                                        </div>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <div class="d-flex align-items-center mb-2">
                                            <i class="ki-duotone ki-black-right fs-4 text-white opacity-75 me-3"></i>
                                            <span class="text-white opacity-75">Halaman</span>
                                        </div>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <div class="d-flex align-items-center mb-2">
                                            <i class="ki-duotone ki-black-right fs-4 text-white opacity-75 me-3"></i>
                                            <span class="text-white opacity-75">Banner</span>
                                        </div>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <div class="d-flex align-items-center mb-2">
                                            <i class="ki-duotone ki-black-right fs-4 text-white opacity-75 me-3"></i>
                                            <span class="text-white opacity-75">Galeri</span>
                                        </div>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <div class="d-flex align-items-center mb-2">
                                            <i class="ki-duotone ki-black-right fs-4 text-white opacity-75 me-3"></i>
                                            <span class="text-white opacity-75">Video</span>
                                        </div>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <div class="d-flex align-items-center mb-2">
                                            <i class="ki-duotone ki-black-right fs-4 text-white opacity-75 me-3"></i>
                                            <span class="text-white opacity-75">Unduhan</span>
                                        </div>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <div class="d-flex align-items-center mb-2">
                                ...
                                <!--end::Wrapper-->
                                <!--begin::Illustrations-->
                                <img class="mw-100 h-225px mx-auto mb-lg-n18" src="{{ asset('assets-apps/media/icon-dashboard/02.svg') }}" draggable="false">
                                <!--end::Illustrations-->
                            </div>
                            <!--end::Card body-->
                        </div>
                    ...
                    <div class="col-xxl-7">
                        ...
                        <div class="card border-0 shadow-none min-h-200px mb-7" style="background-color: #7bbdff">
                            ...
                            <div class="card-body d-flex flex-center flex-wrap">
                                ...
                                <div class="d-flex flex-column align-items-center align-items-md-start flex-grow-1" data-bs-theme="light">
                                    ...
                                    <!--end::List-->
                                    <!--begin::Link-->
                                    <a href="#" class="btn btn-hover-rise text-gray-900 text-uppercase fs-7 fw-bold" style="background-color: #a6d3ff">Buka Aplikasi</a>
                                    <!--end::Link-->
                                </div>
                                <!--end::Wrapper-->
                            </div>
                        ...
                        <div class="row g-lg-7">
                            ...
                            <div class="col-sm-6">
                                <!--begin::Card-->
                                <a href="#" data-bs-toggle="modal" data-bs-target="#kt_modal_create_project" class="card border-0 shadow-none min-h-200px mb-7" style="background-color: #2E4374">
                                    <!--begin::Card body-->
                            ...
                            <div class="col-sm-6">
                                <!--begin::Card-->
                                <a href="#" data-bs-toggle="modal" data-bs-target="#kt_modal_create_account" class="card border-0 shadow-none min-h-200px mb-7" style="background-color: #67426f">
                                    <!--begin::Card body-->
                                    <div class="card-body d-flex flex-column flex-center text-center">
                                        <!--begin::Illustrations-->
                                        <img class="mw-100 h-150px mb-3 mx-auto" src="{{ asset('assets-apps/media/icon-dashboard/06.svg') }}" />
                                        <!--end::Illustrations-->
                                        <!--begin::Heading-->
                                        <h4 class="text-white fw-bold text-uppercase">Pengelolaan <br /> Peneraan</h4>
                                        <!--end::Heading-->
                                    </div>
                                    <!--end::Card body-->
                                </a>
                        ...
                        <div class="row g-lg-7">
                            ...
                            <div class="col-sm-6">
                                <!--begin::Card-->
                                <a href="#" data-bs-toggle="modal" data-bs-target="#kt_modal_create_project" class="card border-0 shadow-none min-h-200px mb-7" style="background-color: #619d7c">
                                    <!--begin::Card body-->
                                    <div class="card-body d-flex flex-column flex-center text-center">
                                        <!--begin::Illustrations-->
                                        <img class="mw-100 h-150px mb-3 mx-auto" src="{{ asset('assets-apps/media/icon-dashboard/07.svg') }}" />
                                        <!--end::Illustrations-->
                                        <!--begin::Heading-->
                            ...
                            <div class="col-sm-6">
                                <!--begin::Card-->
                                <a href="#" data-bs-toggle="modal" data-bs-target="#kt_modal_create_account" class="card border-0 shadow-none min-h-200px mb-7" style="background-color: #dfb017">
                                    <!--begin::Card body-->
                                    <div class="card-body d-flex flex-column flex-center text-center">
                                        <!--begin::Illustrations-->
                                        <img class="mw-100 h-150px mb-3 mx-auto" src="{{ asset('assets-apps/media/icon-dashboard/08.svg') }}" />
                                        <!--end::Illustrations-->
                                        <!--begin::Heading-->
                                        <h4 class="text-white fw-bold text-uppercase">Pengaturan <br /> Aplikasi</h4>
                                        <!--end::Heading-->
                                    </div>
                                    <!--end::Card body-->
                                </a>
    ...
    <div id="kt_sidebar" class="sidebar px-5 py-5 py-lg-8 px-lg-11" data-kt-drawer="true" data-kt-drawer-name="sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="375px" data-kt-drawer-direction="end"
                            ...
                            <div class="timeline-content mb-10 mt-n2">
                                ...
                                <div class="pe-3">
                                    ...
                                    @else
                                        <!--begin::Title-->
                                        <div class="fs-5 text-white fw-semibold mb-2">
                                            {{ $item->publisher->nama_lengkap }} {{ $item->status }}
                                        </div>
                                        <!--end::Title-->
                                    @endif
                                </div>
        ...
        <div class="text-center" id="kt_sidebar_footer">
            <!--begin::Link-->
            <a href="#" class="btn btn-hover-rise text-white bg-white bg-opacity-10 text-uppercase fs-7 fw-bold">Lihat Update 30 Hari Terakhir</a>
            <!--end::Link-->
        </div>
        <!--end::Footer-->
    </div>
