                        ...
                        <div class="card border-0 shadow-none h-lg-100" style="background-color: #6E16B5">
                            ...
                            <div class="card-body d-flex flex-column flex-center pb-0 pt-15">
                                ...
                                <div class="px-10 mb-5">
                                    ...
                                    {{-- end::List --}}
                                    {{-- begin::Link --}}
                                    <a href="{{ route('prt.apps.home.index') }}" class="btn btn-hover-rise text-white bg-white bg-opacity-10 text-uppercase fs-7 fw-bold w-xxl-350px">Buka Dashboard Portal</a>
                                    {{-- end::Link --}}
                                </div>
                                {{-- end::Wrapper --}}
                                {{-- begin::Illustrations --}}
