                    ...
                    <div class="col-xxl-12">
                        ...
                        <div class="card border-0 shadow-none min-h-200px mb-7" style="background-color: #7bbdff">
                            ...
                            <div class="card-body d-flex flex-center flex-wrap">
                                {{-- begin::Illustrations --}}
                                <img class="h-200px me-4 mb-5" src="{{ asset('assets-apps/media/icon-dashboard/04.svg') }}" draggable="false">
                                {{-- end::Illustrations --}}
                                {{-- begin::Wrapper --}}
                                <div class="d-flex flex-column align-items-center align-items-md-start flex-grow-1" data-bs-theme="light">
                                    {{-- begin::Heading --}}
                                    <h3 class="text-gray-900 fw-bolder text-uppercase mb-5">Penjadwalan &Penugasan</h3>
                                    {{-- end::Heading --}}
                                    {{-- begin::List --}}
                                    <div class="mb-5 text-center text-md-start">
                                        Verifikasi pengajuan, penjadwalan, dan penugasan.
                                    </div>
                                    {{-- end::List --}}
                                    {{-- begin::Link --}}
                        ...
                        <div class="card border-0 shadow-none min-h-200px mb-7" style="background-color: #dfb017">
                            ...
                            <div class="card-body d-flex flex-center flex-wrap">
                                {{-- begin::Illustrations --}}
                                <img class="h-200px me-4 mb-5" src="{{ asset('assets-apps/media/icon-dashboard/08.svg') }}" draggable="false">
                                {{-- end::Illustrations --}}
                                {{-- begin::Wrapper --}}
                                <div class="d-flex flex-column align-items-center align-items-md-start flex-grow-1" data-bs-theme="light">
                                    {{-- begin::Heading --}}
                                    <h3 class="text-gray-900 fw-bolder text-uppercase mb-5">PengaturanAplikasi</h3>
                                    {{-- end::Heading --}}
                                    {{-- begin::List --}}
                                    <div class="mb-5 text-center text-md-start">
