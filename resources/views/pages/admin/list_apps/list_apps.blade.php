                ...
                <div class="row g-7 w-xxl-850px">
                    ...
                    <div class="col-xxl-7">
                        ...
                        <div class="row g-lg-7">
                            ...
                            <div class="col-sm-6">
                                {{-- begin::Card --}}
                                <a href="#" class="card border-0 shadow-none min-h-200px mb-7" style="background-color: #67426f">
                                    {{-- begin::Card body --}}
                            ...
                            <div class="col-sm-6">
                                {{-- begin::Card --}}
                                <a href="#" class="card border-0 shadow-none min-h-200px mb-7" style="background-color: #619d7c">
                                    {{-- begin::Card body --}}
                                    <div class="card-body d-flex flex-column flex-center text-center">
                                        {{-- begin::Illustrations --}}
                        ...
                        <div class="row g-lg-7">
                            ...
                            <div class="col-sm-6">
                                {{-- begin::Card --}}
                                <a href="{{ route('set.apps.home.index') }}" class="card border-0 shadow-none min-h-200px mb-7" style="background-color: #dfb017">
                                    {{-- begin::Card body --}}
                                    <div class="card-body d-flex flex-column flex-center text-center">
                                        {{-- begin::Illustrations --}}
