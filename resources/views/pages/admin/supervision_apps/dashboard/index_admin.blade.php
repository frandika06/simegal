@extends('layouts.admin.supervision')
@push('apps')
    SIMEGAL
@endpush
@push('title')
...
@endpush
@push('description')
    Pengawasan | Sistem Informasi Metrologi Legal Pemerintah Kabupaten Tangerang
@endpush
@push('header-title')
    Pengawasan
@endpush
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="card-px text-center pt-15 pb-15">
                        ...
                        {{-- end::Title --}}
                        {{-- begin::Description --}}
                        <p class="text-gray-400 fs-4 fw-semibold py-7">Selamat datang di Pengawasan.
                    ...
                    <div class="text-center pb-15 px-5">
                        <img src="{{ asset('assets-apps/media/icon-dashboard/09.png') }}" alt="" class="mw-100 h-200px h-sm-325px" />
                    </div>
                    {{-- end::Illustration --}}
                </div>
                {{-- end::Card body --}}
