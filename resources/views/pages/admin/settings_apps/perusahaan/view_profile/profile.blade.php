...
@endpush
@push('title')
    Detail {{ $profile->nama_perusahaan }} | SIMEGAL
@endpush
@push('description')
    Detail {{ $profile->nama_perusahaan }} | Sistem Informasi Metrologi Legal Pemerintah Kabupaten Tangerang
@endpush
@push('header-title')
    Detail {{ $profile->nama_perusahaan }}
@endpush
@push('styles')
