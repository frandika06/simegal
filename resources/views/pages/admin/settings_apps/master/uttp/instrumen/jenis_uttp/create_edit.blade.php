    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="card pt-4 mb-6 mb-xl-9">
                ...
                <div class="card-body">
                    {{-- begin::Form --}}
                    <form action="{{ route('set.apps.mst.ins.uttp.jenis.update', [$enc_uuid]) }}" class="form" enctype="multipart/form-data" method="POST">
                        @csrf
                        @method('put')
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control @error('nama_jenis_uttp') is-invalid @enderror" name="nama_jenis_uttp" id="nama_jenis_uttp" placeholder="Nama Jenis UTTP" autocomplete="off" maxlength="100" value="{{ old('nama_jenis_uttp', $data->nama_jenis_uttp) }}" required />
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-lg-9">
                                ...
                                <div class="form-check form-check-custom form-check-solid mb-4 mt-5">
                                    <input class="form-check-input @error('status_volume') is-invalid @enderror" type="radio" value="1" name="status_volume" id="volume" @if ($data->status_volume == '1') checked @endif />
                                ...
                                <div class="form-check form-check-custom form-check-solid mb-4">
                                    <input class="form-check-input @error('status_volume') is-invalid @enderror" type="radio" value="0" name="status_volume" id="non_volume" @if ($data->status_volume == '0') checked @endif />
