                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('set.apps.mst.ins.uttp.item.update', [$enc_uuid]) }}" class="form" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="row form-group">
                            <div class="col-lg-3">
                                <label for="nama_jenis_uttp" class="required">Nama Daftar Item UTTP</label>
                            </div>
                            <div class="col-lg-9">
                                <input type="text" class="form-control @error('nama_jenis_uttp') is-invalid @enderror" name="nama_jenis_uttp" id="nama_jenis_uttp" placeholder="Nama Daftar Item UTTP" autocomplete="off" maxlength="100" value="{{ old('nama_jenis_uttp', $data->nama_jenis_uttp) }}"
                                    required />
