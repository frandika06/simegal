            ...
            <div class="card pt-4 mb-6 mb-xl-9">
                ...
                <div class="card-body">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control" value="{{ $data->nama_kelompok }}" readonly />
                        </div>
                    </div>
                    {{-- end::nama_kelompok --}}
                    ...
                    <div class="d-flex justify-content-end align-items-center mt-12">
                        <a href="{{ route('set.apps.mst.uttp.klpk.index') }}" class="btn btn-secondary"><i class="fa-solid fa-times-circle"></i> Tutup</a>
                    </div>
                    {{-- begin::Action buttons --}}
                </div>
                {{-- end::Card body --}}
