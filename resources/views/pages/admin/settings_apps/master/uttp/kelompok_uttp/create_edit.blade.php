        ...
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
            ...
            <div class="page-title d-flex flex-column me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
                    ...
                    {{-- begin::Item --}}
                    <li class="breadcrumb-item text-muted">
                        <a href="{{ route('set.apps.mst.uttp.klpk.index') }}" class="text-muted text-hover-primary">Kelompok UTTP</a>
                    </li>
                    {{-- end::Item --}}
                    {{-- begin::Item --}}
                    <li class="breadcrumb-item">
            ...
            <div class="d-flex align-items-center py-2 py-md-1">
                {{-- begin::Button --}}
                <a href="{{ route('set.apps.mst.uttp.klpk.index') }}" class="btn btn-dark btn-sm btn-icon"><i class="fa-solid fa-chevron-left"></i></a>
                {{-- end::Button --}}
            </div>
            {{-- end::Actions --}}
        </div>
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="card pt-4 mb-6 mb-xl-9">
                ...
                <div class="card-body">
                    {{-- begin::Form --}}
                    <form action="{{ route('set.apps.mst.uttp.klpk.update', [$enc_uuid]) }}" class="form" enctype="multipart/form-data" method="POST">
                        @csrf
                        @method('put')
                        ...
                        <div class="row form-group mb-5">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control @error('kode') is-invalid @enderror" name="kode" id="kode" placeholder="Kode" autocomplete="off" maxlength="100" value="{{ old('kode', $data->kode) }}" required />
                                @error('kode')
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control @error('nama_kelompok') is-invalid @enderror" name="nama_kelompok" id="nama_kelompok" placeholder="Nama Kelompok" autocomplete="off" maxlength="100" value="{{ old('nama_kelompok', $data->nama_kelompok) }}" required />
                                @error('nama_kelompok')
