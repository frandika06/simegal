    ...
    <div class="card pt-4 mb-6 mb-xl-9">
        ...
        <div class="card-header border-0">
            ...
            <div class="card-title flex-column">
                <h2>Data Profile</h2>
                <div class="fs-6 fw-semibold text-muted">Halaman untuk mengubah data profile kepala bidang.</div>
            </div>
            {{-- end::Card title --}}
        </div>
        {{-- end::Card header --}}
        ...
        <div class="card-body">
            {{-- begin::Form --}}
            <form action="{{ route('set.apps.kabid.update', [$enc_uuid]) }}" class="form" enctype="multipart/form-data" method="POST">
                @csrf
                @method('put')
                {{-- hidden --}}
