    ...
    <div class="toolbar py-5 py-lg-5" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
            ...
            <div class="page-title d-flex flex-column me-3">
                {{-- begin::Title --}}
                <h1 class="d-flex text-dark fw-bold my-1 fs-3">Kepala Dinas</h1>
                {{-- end::Title --}}
                {{-- begin::Breadcrumb --}}
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
                    ...
                    {{-- begin::Item --}}
                    <li class="breadcrumb-item text-muted">
                        <a href="{{ route('set.apps.kadis.index') }}" class="text-muted text-hover-primary">Kepala Dinas</a>
                    </li>
                    {{-- end::Item --}}
                    {{-- begin::Item --}}
                    <li class="breadcrumb-item">
                    ...
                    {{-- end::Item --}}
                    {{-- begin::Item --}}
                    <li class="breadcrumb-item text-dark">Detail Kepala Dinas</li>
                    {{-- end::Item --}}
                </ul>
                {{-- end::Breadcrumb --}}
            </div>
            ...
            <div class="d-flex align-items-center py-2 py-md-1">
                {{-- begin::Button --}}
                <a href="{{ route('set.apps.kadis.index') }}" class="btn btn-dark btn-sm btn-icon"><i class="fa-solid fa-chevron-left"></i></a>
                {{-- end::Button --}}
            </div>
            {{-- end::Actions --}}
        </div>
            ...
            <div class="d-flex flex-column flex-lg-row">
                ...
                <div class="flex-lg-row-fluid ms-lg-15">
                    ...
                    <div class="tab-content" id="myTabContent">
                        {{-- path-profile::begin --}}
                        @include('pages.admin.settings_apps.kadis.view_profile.path_profile')
                        {{-- path-profile::end --}}
                        {{-- path-keamanan::begin --}}
                        @include('pages.admin.settings_apps.kadis.view_profile.path_log')
                        {{-- path-keamanan::end --}}
                    </div>
                    {{-- end:::Tab content --}}
