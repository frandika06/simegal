        ...
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
            ...
            <div class="page-title d-flex flex-column me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
                    ...
                    {{-- end::Item --}}
                    {{-- begin::Item --}}
                    <li class="breadcrumb-item text-dark">Edit Kepala Dinas</li>
                    {{-- end::Item --}}
                </ul>
                {{-- end::Breadcrumb --}}
            </div>
            ...
            <div class="d-flex flex-column flex-lg-row">
                ...
                <div class="flex-lg-row-fluid ms-lg-15">
                    ...
                    <div class="tab-content" id="myTabContent">
                        {{-- path-profile::begin --}}
                        @include('pages.admin.settings_apps.kadis.edit_profile.path_profile')
                        {{-- path-profile::end --}}
                        {{-- path-keamanan::begin --}}
                        @include('pages.admin.settings_apps.kadis.edit_profile.path_keamanan')
                        {{-- path-keamanan::end --}}
                        {{-- path-keamanan::begin --}}
                        @include('pages.admin.settings_apps.kadis.edit_profile.path_log')
                        {{-- path-keamanan::end --}}
                    </div>
                    {{-- end:::Tab content --}}
