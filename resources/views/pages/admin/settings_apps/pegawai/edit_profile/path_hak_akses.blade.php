    ...
    <div class="card pt-4 mb-6 mb-xl-9">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('set.apps.pegawai.update', [$enc_uuid]) }}" class="form" enctype="multipart/form-data" method="POST">
                ...
                {{-- begin::Ketua Tim --}}
                <div class="form-check mb-5">
                    <input class="form-check-input @error('sub_role') is-invalid @enderror" type="checkbox" value="Ketua Tim" name="sub_role[]" id="ketua_tim" @if (in_array('Ketua Tim', $exsub_role)) checked @endif />
                ...
                <div class="d-none" id="sub_role_ketua_tim">
                    ...
                    <div class="ps-5 pt-3">
                        ...
                        <div class="form-check form-check-custom form-check-solid mb-4">
                            <input class="form-check-input @error('sub_role_ketua_tim') is-invalid @enderror" type="radio" value="Ketua Tim Pelayanan" name="sub_role_ketua_tim" id="Pelayanan" @if (in_array('Ketua Tim Pelayanan', $exsub_sub_role)) checked @endif />
                        ...
                        <div class="form-check form-check-custom form-check-solid mb-4">
                            <input class="form-check-input @error('sub_role_ketua_tim') is-invalid @enderror" type="radio" value="Ketua Tim Pengawasa" name="sub_role_ketua_tim" id="Pengawasan" @if (in_array('Ketua Tim Pengawasa', $exsub_sub_role)) checked @endif />
                        ...
                        <div class="form-check form-check-custom form-check-solid mb-4">
                            <input class="form-check-input @error('sub_role_ketua_tim') is-invalid @enderror" type="radio" value="Ketua Tim Bina SDM" name="sub_role_ketua_tim" id="SDM" @if (in_array('Ketua Tim Bina SDM', $exsub_sub_role)) checked @endif />
