            ...
            <div class="row">
                <div class="col" style="min-height: 250px;">
                    <div class="row portfolio-list lightbox" data-plugin-options="{'delegate': 'a.lightbox-portfolio', 'type': 'image', 'gallery': {'enabled': true}}">
                        @foreach ($data->RelDataGaleri as $item)
                                ...
                                <div class="portfolio-item">
                                    <span class="thumb-info thumb-info-lighten thumb-info-centered-icons border-radius-0">
                                        <span class="thumb-info-wrapper border-radius-0">
                                            <img src="{{ \CID::urlImg($item->url) }}" class="img-fluid border-radius-0" alt="">
                                            <span class="thumb-info-action">
                                                <a href="{{ \CID::urlImg($item->url) }}" class="lightbox-portfolio">
            ...
            <div class="row pt-4 mt-2 mb-5">
                ...
                <div class="col-md-5 appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="1400">
                    ...
                    <ul class="list list-icons list-primary list-borders text-2">
                        ...
                        <li><i class="fas fa-caret-right left-10"></i> <strong class="text-color-primary">Tanggal:</strong> {{ \CID::hariTgl($data->created_at) }}</li>
